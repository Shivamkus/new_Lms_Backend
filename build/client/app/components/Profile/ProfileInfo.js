...
const ProfileInfo = ({ avatar, user }) => {
    ...
    const [phoneNumber, setPhoneNumber] = (0, react_1.useState)(user && user.phoneNumber);
        ...
        <form onSubmit={handleSubmit}>
          <div className="800px:w-[50%] m-auto block pb-4">
            ...
            <div className="w-[100%]">
              ...
              <input type="number" className={`${style_1.styles.input} !w-[95%] mb-4 800px:mb-0`} 
    // readOnly
    required value={phoneNumber} onChange={(phone) => setPhoneNumber(phone.target.value)}/>
            </div>
