      ...
      <react_pro_sidebar_1.ProSidebar collapsed={isCollapsed} style={{
        ...
        <react_pro_sidebar_1.Menu iconShape="square">
          ...
          <material_1.Box paddingLeft={isCollapsed ? undefined : "10%"}>
            ...
            <Item title="Users" to="/admin/users" icon={<Icon_1.GroupsIcon />} selected={selected} setSelected={setSelected}/>
            ...
            <Item title="Live classes" to="/admin/courses" icon={<Icon_1.OndemandVideoIcon />} selected={selected} setSelected={setSelected}/>
              <Item title="Add Test" to="/admin/create-test" icon={<Icon_1.SettingsIcon />} selected={selected} setSelected={setSelected}/>
            <material_1.Typography variant="h5" className="!text-[18px] text-black dark:text-[#ffffffc1] capitalize !font-[400]" sx={{ m: "15px 0 5px 20px" }}>
