      ...
      <form onSubmit={handleSubmit} className={`${style_1.styles.label}`}>
        ...
        <div className="w-full flex justify-between">
          ...
          <div className="w-[50%]">
            ...
            <select name="" id="" className={`${style_1.styles.select}`} value={courseInfo.category} onChange={(e) => setCourseInfo({ ...courseInfo, categories: e.target.value })}>
        ...
        <div className="w-full">
          ...
          <label htmlFor="file" className={`w-full min-h-[10vh] dark:border-white border-[#00000026] p-3 border flex items-center justify-center ${dragging ? "bg-blue-500" : "bg-transparent"}`} onDragOver={handleDragOver} onDragLeave={handleDragLeave} onDrop={handleDrop}>
            {courseInfo.thumbnail ? (<image_1.default src={courseInfo.thumbnail} alt="" className="max-h-full w-full object-cover"/>) : (<span className="text-black dark:text-white">
